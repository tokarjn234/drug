...
@section('content')
    ...
    <div id="page-wrapper" ng-controller="IssueCertificatesController" >
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="issueForm" method="POST" action="{{ action('Mediaid\CertificatesController@postIssueCertificates') }}">
                    {{ csrf_field() }}
                ...
                <div class="dataTable_wrapper" style="width: 70%;margin:0 auto;">
                    ...
                    <div class="center-block text-center">
                        ...
                        <a href="{{action('Mediaid\CertificatesController@getIndex')}}" class="btn btn-primary btn-lg" type="submit">戻る</a>
