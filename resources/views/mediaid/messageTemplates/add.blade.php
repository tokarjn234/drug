...
@section('content')
    ...
    <div id="page-wrapper" class="edit-template" >
        <!-- /.row -->
        <div class="row">
        <form id="myForm" action="{{action('Mediaid\MessageTemplatesController@postAdd')}}"  method="POST">
        {{ csrf_field() }}
            <div class="col-lg-12">
                ...
                <div class="group-btn">
                    ...
                    <button id="notActiveStatus" class="btn btn-primary submitBtn" type="submit">下書き</button>
                    <button id="activeStatus" class="btn btn-primary submitBtnt"  type="submit">適用</button>
