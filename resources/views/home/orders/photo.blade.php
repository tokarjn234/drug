...
@section('content')
    <div class="check-presc">
        <div class="control-top clearfix no-print">
            <div class="info-left">
                <table>
                    <colgroup>
                        <col width="30%">
                    ...
                    <tr>
                        <td colspan="2">電話番号: {{\App\Models\User::getPhoneNumberAttribute($order->phone_number)}}</td>
                    </tr>
                    <tr>
					...
					<tr>
                        <td style="word-break: break-all; white-space: pre-wrap;" colspan="2">コメント: {{$order->comment}}</td>
                    </tr>
                </table>
                <!--/info-left-->
            </div>
        ...
        <div class="view-presc no-print" id="photo"></div>
    ...
    <div class="print-image">
        @foreach($photos as $photo)
            ...
            <div class="text-align-center photo-print">
                {!! $photo['photo_url'] !!}
            </div>
        @endforeach
    </div>
