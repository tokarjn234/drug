    ...
    <div class="row" ng-controller="AuthUpdateProfileController">
        ...
        <div class="col-lg-12">
            ...
            <form id="profileForm" class="form-inline" ng-submit="confirm($event)" method="POST"
                  action="{{action('Home\AuthController@updateProfile')}}">
                {{csrf_field()}}
...
<<<<<<< HEAD
                            <div class="txt-center text-job-Category" ng-show="isConfirmMode">{!! \App\Models\Staff::$jobCategory[$jsonData['staff']['job_category']] !!}</div>
=======
                            <div class="txt-center text-job-Category" ng-show="isConfirmMode">{!! @\App\Models\Staff::$jobCategory[$jsonData['staff']['job_category']] !!}</div>
>>>>>>> drugorder_release20160328
                    ...
                    <tr>
                        ...
                        <td>
                            <input ng-show="!isConfirmMode" ng-model="Staff.position" name="position" type="text"
                                   class="form-control w350" id="" placeholder="役職">

                            <div class="txt-center" ng-show="isConfirmMode" ng-bind="Staff.position"></div>
                        </td>
                    </tr>
                ...
                @if ($cancelable)
                    <div class="btn-Registration center-block txt-center">
                        ...
                        <a href="{{action('Home\AuthController@profile')}}" class="btn btn-primary w150">キャンセル</a>
