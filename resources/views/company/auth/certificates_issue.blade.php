...
@section('content')
    ...
    <div class="row" ng-controller="AuthCertificatesIssueController">
        ...
        <div class="col-lg-12">
            ...
            <form id="issueForm" role="form" ng-submit="downloadCert($event)"  method="POST" action="{{action('Company\AuthController@certificates')}}">
                {{csrf_field()}}
            ...
            <table class="table table-striped no-hover-color">
                ...
                <div class="txt-center">
                        ...
                        <a href="{{action('Company\AuthController@certificates', ['_'=>time()])}}" class="btn btn-primary">キャンセル</a>
