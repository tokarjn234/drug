...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 settings-user">
                <p><i class="fa fa-stop"></i> 本部アカウント管理</p>
                ...
                <table class="table table-striped table table-user">
                    ...
                    @foreach($staffs as $key => $staff)
                        ...
                        <tr class="@if ($staff->status === @\App\Models\Staff::STATUS_DELETED)
                                    {{'row_gray'}}
                                    @endif;">
                            ...
                            <td>{{empty ($staff->job_category) ? '-' : $staff->job_category}}</td>
                            <td>{{empty ($staff->position) ? '-' : $staff->position}}</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <a href="{{action('Company\CompanyStaffsController@getCreate')}}" class="btn btn-primary">新規作成</a>
                        </td>
                        <td>
    ...
    <form action="{!! action('Company\CompanyStaffsController@postDelete') !!}" id="form-update-status" method="post">
        {{csrf_field()}}
