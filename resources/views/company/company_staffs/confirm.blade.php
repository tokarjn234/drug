...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="staff-create-info" style="border: none">
                    <p>{!! !empty($mess)?$mess:session('mess') !!}</p>
                </div>
                    ...
                    <form>
                        ...
                        <div>
                            <table class="tbl-staff-create" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><input name="member_id" class="form-control display-inline" readonly type="text"
                                               placeholder=""
                                               value="{!! empty($company_id)?session('company_id'):$company_id !!}"></td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="clearfix">
                            <div class="center-block text-center">
                                <a href="{{ action('Company\CompanyStaffsController@getIndex') }}"
    ...
    <script type="text/javascript">
        ...
        function Popup(data) {
            ...
            mywindow.document.write('<p>スマホ処方メール本部管理画面のアカウントを発行いたします。<br/>以下の初期パスワードにて「スマホ処方めーる管理画面」にアクセスをし、パスワード変更を行ってください。<br />※「スマホ処方めーる管理画面」は、端末証明書が導入されているPCからしかアクセスすることはできません。</p>');
