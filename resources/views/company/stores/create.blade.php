        ...
        <div class="row">
            <div class="col-lg-12">
                <p class="txtNote clearfix">アプリの店舗検索画面上に表示されている内容です。
                    {{--<span class="name-company">店舗ID：{{ $store['id'] or '' }}</span>--}}
                </p>
                @if (count($errors) > 0)
                ...
                <table id="dataTables-example" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input class="form-control" required maxlength="30" type="text"
                                               name="internal_code"></td>
                    </tr>

                    <tr>
                        <th colspan="2">店舗名</th>
                        <td colspan="3"><input class="form-control" required maxlength="30" type="text" name="name">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th>都道府県</th>
                        <td>
                            {!! Form::select('province', $provinces, null , ['class'=> 'form-control w150 address', 'id' => 'province', 'style' => 'width: 200px']) !!}
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <div id="map"></div>
                            <input type="hidden" value="35.6735408" name="map_coordinates_lat" id="map_coordinates_lat">
                            <input type="hidden" value="139.5703048" name="map_coordinates_long" id="map_coordinates_long">
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">電話</th>
                        <td colspan="3">
                            <input required class="form-control w80 display-inline number-only" type="text"
                                   maxlength="5" name="phone_number[0]"> -
                            <input required class="form-control w80 display-inline number-only" type="text"
                                   maxlength="4" name="phone_number[1]"> -
                            <input required class="form-control w80 display-inline number-only" type="text"
                                   maxlength="4" name="phone_number[2]">
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">FAX</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            {!! Form::select('accept_credit_card', array('0' => '不可', '1' => '可能'), $storeInputSetting->accept_credit_card['data']['accept'] ? '1' : '0', array('class'=> 'form-control w100 display-inline pa4','id' => 'accept_credit_card')) !!}
                            -
                            <input id="credit_card_type" class="form-control w60-percent display-inline"
                                   name="credit_card_type"
                                   value="{{$storeInputSetting->accept_credit_card['data']['card_type']}}">
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">駐車場</th>
                        <td colspan="3">
                            <input maxlength="30" class="form-control w60-percent" type="text" name="park_info"
                                   placeholder="あり（20台)" value="{{$storeInputSetting->park_info['data']}}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea rows="4" class="form-control w60-percent display-inline" id="description"
                                      ...
                                      name="description">{{$storeInputSetting->description['data']}}</textarea>
                            <span>※200文字まで</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" style="vertical-align:top !important">
                            ...
                            @foreach (\App\Models\Store::$days as $key => $val)
                                ...
                                <div class="clearfix pb5">
                                    {!! $val . '' . Form::select('times_open[' . $key . ']', \App\Models\Store::$hoursOpen, null , array('class' => 'form-control select-time', 'id' => 'times_'.$key)) !!}
                                    ～
                                    {!! Form::select('times_close[' . $key . ']', \App\Models\Store::$hoursClose, null , array('class' => 'form-control select-time', 'id' => 'times_'.$key.'_close')) !!}
                                </div>

                            @endforeach

                            <div class="txtInfo txtInfo-edit">
                                {!! Form::textarea('note', $storeInputSetting->note_working_time['data'], ['class' => 'form-control', 'rows' => 2, 'id' => 'note', 'maxlength' => 100]) !!}
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            @if($enableCreate)
                                <label class="pl10 font-normal">{!! Form::radio('is_published', 1, true, array('class'=>'pl10') ) !!}
                                    公開 </label>
                                <label class="pl10 font-normal">{!! Form::radio('is_published', 0, null, array('class'=>'pl10') ) !!}
                                    非公開 </label>
                            @else
                                <label class="pl10 font-normal">{!! Form::radio('is_published', 0, true, array('class'=>'pl10') ) !!}
                                    非公開 </label>
                            @endif
                        </td>
                    </tr>
        ...
        function readURL(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('#image-store').attr('src', e.target.result)
                };
